...
const init = async () => {
  ...
  client.logger.log(`Chargement de ${evtFiles.length} évènement.`, "log");
  evtFiles.forEach(file => {
    const eventName = file.split(".")[0];
    client.logger.log(`Chargement de l'évènement: ${eventName}`);
